...
////	
	...
	public ResponseEntity<ApiResponse<List<EmployeeDto>>> employeesUnderManager(@PathVariable Integer employeeid) {
		List<EmployeeDto> employeeDtolist = employeeService.EmployeesUnderManager(employeeid);
		Map<String, Object> meta = new LinkedHashMap<>();
		meta.put("employeeCount", employeeDtolist.size());
		return ResponseEntity.ok(new ApiResponse<>(employeeDtolist, meta));
	}
	...
	public ResponseEntity<ApiResponse<List<EmployeeDto>>> managersInADepartment(@PathVariable Integer departmentId){
		
		List<EmployeeDto> managerDtoListInTheDepartment = employeeService.managersInTheDepartment(departmentId);
		Map<String, Object> meta = new LinkedHashMap<>();
		meta.put("managersCount", managerDtoListInTheDepartment.size());
		return ResponseEntity.ok(new ApiResponse<>(managerDtoListInTheDepartment, meta));
	}
}
